...
// Complete staff data - ALL 349 employees from your list
const allStaffData = [
  // Academic Affairs
...
async function importAll349Staff() {
  try {
    console.log('🚀 Starting import of ALL 349 staff members...');
    console.log(`📊 Processing ${allStaffData.length} employees from the complete list...`);
