import { GraphMailProvider } from './providers/graphMailProvider';
import { SmtpMailProvider } from './providers/smtpMailProvider';
...
export class NotificationService {
  private provider: GraphMailProvider | SmtpMailProvider;
  ...
  async sendAppraisalSubmittedEmployee(
  ...
  async sendAppraisalSubmittedHR(
    employee: EmployeeData,
    appraisal: AppraisalData,
    cycle: CycleData
  ): Promise<void> {
  ...
  private generateEmployeeEmailHTML(
    employee: EmployeeData,
    appraisal: AppraisalData,
    cycle: CycleData
  ): string {
